...
<div class="agtdvw-s">
    ...
    <div class="agtdvw-m">
        <div class="agtdvw-c">
            ...
            <div>
                <div class="agtdvw-r">
                    <span class="agtdvw-l">رقم المستند</span>
                    <span class="agtdvw-v">{{ $doc->document_number ?? '—' }}</span>
                </div>
                <div class="agtdvw-r">
                    <span class="agtdvw-l">جهة الإصدار</span>
                    <span class="agtdvw-v">{{ $doc->issuing_authority ?? '—' }}</span>
                </div>
                <div class="agtdvw-r">
                    <span class="agtdvw-l">تاريخ الإصدار</span>
                    <span class="agtdvw-v">{{ $doc->issue_date?->format('Y/m/d') ?? '—' }}</span>
                </div>
                <div class="agtdvw-r">
                    <span class="agtdvw-l">تاريخ الانتهاء</span>
                    <span class="agtdvw-v">
                        @if($doc->expiry_date)
                ...
                <div class="agtdvw-r">
                    <span class="agtdvw-l">حجم الملف</span>
                    <span class="agtdvw-v">{{ $doc->file_size ? number_format($doc->file_size / 1024, 1) . ' KB' : '—' }}</span>
                </div>
                <div class="agtdvw-r">
                    <span class="agtdvw-l">تاريخ الرفع</span>
                    <span class="agtdvw-v">{{ $doc->created_at->format('Y/m/d · H:i') }}</span>
                </div>
            </div>
            @if($doc->rejection_reason)
            <div style="margin-top:0.75rem;padding:0.75rem 1rem;border-radius:var(--radius-sm);background:var(--danger-light);">
                <p style="font-size:.72rem;font-weight:700;color:var(--danger);margin-bottom:0.2rem;">سبب الرفض:</p>
