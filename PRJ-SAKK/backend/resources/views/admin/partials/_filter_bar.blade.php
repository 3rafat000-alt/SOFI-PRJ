    ...
    <div class="card-body">
        <form method="GET" action="{{ $route }}">
            <div class="filter-grid">
                ...
                <div>
                    <label for="flt-{{ $f['name'] }}" class="label">{{ $f['label'] }}</label>
                    <select id="flt-{{ $f['name'] }}" name="{{ $f['name'] }}" class="input">
