# HANDOFFS (ticket queue) — SAAS-077
...
task: Discovery — user research, journey mapping, problem validation for TobaccoShop
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for TobaccoShop
...
task: Architecture — system design, data flow, stack decisions for TobaccoShop
