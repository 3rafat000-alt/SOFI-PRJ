# HANDOFFS (ticket queue) — SAAS-090
> Project: FurniturePro
...
task: furniture showroom management architecture — product catalog with variants, AR model pipeline, order lifecycle, delivery scheduling, installation crew management, inventory tracking
