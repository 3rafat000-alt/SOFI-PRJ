# HANDOFFS (ticket queue) — SAAS-100
...
task: produce Journey Map for SAAS-100 (AutoMarket)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/06-commerce/SAAS-100/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-100 (AutoMarket)
...
task: produce Architecture Spec for SAAS-100 (AutoMarket)
