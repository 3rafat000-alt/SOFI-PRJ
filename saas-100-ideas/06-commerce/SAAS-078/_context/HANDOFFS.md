# HANDOFFS (ticket queue) — SAAS-078
...
task: Discovery — user research, journey mapping, problem validation for ButcherPro
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for ButcherPro
...
task: Architecture — system design, data flow, stack decisions for ButcherPro
