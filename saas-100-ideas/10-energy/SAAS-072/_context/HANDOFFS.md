# HANDOFFS (ticket queue) — SAAS-072
...
task: Discovery — user research, journey mapping, problem validation for RooftopSolar
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for RooftopSolar
...
task: Architecture — system design, data flow, stack decisions for RooftopSolar
