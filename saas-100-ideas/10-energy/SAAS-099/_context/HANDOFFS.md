# HANDOFFS (ticket queue) — SAAS-099
...
task: produce Journey Map for SAAS-099 (PowerBackup)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/10-energy/SAAS-099/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-099 (PowerBackup)
...
task: produce Architecture Spec for SAAS-099 (PowerBackup)
