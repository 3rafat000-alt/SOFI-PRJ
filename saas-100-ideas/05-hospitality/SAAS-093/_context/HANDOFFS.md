# HANDOFFS (ticket queue) — SAAS-093
...
task: produce Journey Map for SAAS-093 (HallBooking)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/05-hospitality/SAAS-093/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-093 (HallBooking)
...
task: produce Architecture Spec for SAAS-093 (HallBooking)
