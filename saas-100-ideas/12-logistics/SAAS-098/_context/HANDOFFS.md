# HANDOFFS (ticket queue) — SAAS-098
...
task: produce Journey Map for SAAS-098 (CourierMgt)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/12-logistics/SAAS-098/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-098 (CourierMgt)
...
task: produce Architecture Spec for SAAS-098 (CourierMgt)
