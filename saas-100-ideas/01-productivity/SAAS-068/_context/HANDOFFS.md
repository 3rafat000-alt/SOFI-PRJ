# HANDOFFS (ticket queue) — SAAS-068
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for CoachingPro.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for CoachingPro.
