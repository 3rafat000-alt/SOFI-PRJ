# HANDOFFS (ticket queue) — SAAS-076
...
task: Discovery — user research, journey mapping, problem validation for ExamPro
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for ExamPro
...
task: Architecture — system design, data flow, stack decisions for ExamPro
