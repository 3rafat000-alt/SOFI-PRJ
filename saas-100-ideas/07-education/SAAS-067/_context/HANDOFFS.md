# HANDOFFS (ticket queue) — SAAS-067
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for SchoolEase.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for SchoolEase.
