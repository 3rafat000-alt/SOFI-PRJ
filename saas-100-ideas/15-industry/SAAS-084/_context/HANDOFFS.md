# HANDOFFS (ticket queue) — SAAS-084
> Project: PrintHub
...
task: print shop management architecture — order workflow engine, proof approval system, production scheduling, delivery tracking, invoicing
