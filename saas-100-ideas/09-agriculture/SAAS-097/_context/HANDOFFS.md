# HANDOFFS (ticket queue) — SAAS-097
...
task: produce Journey Map for SAAS-097 (FishFarm)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/09-agriculture/SAAS-097/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-097 (FishFarm)
...
task: produce Architecture Spec for SAAS-097 (FishFarm)
