# HANDOFFS (ticket queue) — SAAS-075
...
task: Discovery — user research, journey mapping, problem validation for SouqFarmer
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for SouqFarmer
...
task: Architecture — system design, data flow, stack decisions for SouqFarmer
