# HANDOFFS (ticket queue) — SAAS-086
> Project: CableTV
...
task: cable TV & internet provider architecture — subscription lifecycle, automated billing, ticket/SLA management, technician dispatch, CPE tracking, outage management
