# HANDOFFS (ticket queue) — SAAS-096
...
task: produce Journey Map for SAAS-096 (NGOmgt)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/11-services/SAAS-096/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-096 (NGOmgt)
...
task: produce Architecture Spec for SAAS-096 (NGOmgt)
