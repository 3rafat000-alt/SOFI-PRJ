# HANDOFFS (ticket queue) — SAAS-070
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for RepairPro.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for RepairPro.
