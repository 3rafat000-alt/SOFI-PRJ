# HANDOFFS (ticket queue) — SAAS-094
...
task: produce Journey Map for SAAS-094 (ToolRental)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/11-services/SAAS-094/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-094 (ToolRental)
...
task: produce Architecture Spec for SAAS-094 (ToolRental)
