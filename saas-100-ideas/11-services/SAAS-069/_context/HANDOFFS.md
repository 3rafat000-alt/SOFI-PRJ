# HANDOFFS (ticket queue) — SAAS-069
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for WeddingOrg.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for WeddingOrg.
