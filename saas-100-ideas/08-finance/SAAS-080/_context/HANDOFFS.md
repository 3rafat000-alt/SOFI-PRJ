# HANDOFFS (ticket queue) — SAAS-080
...
task: Discovery — user research, journey mapping, problem validation for BankMicro
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for BankMicro
...
task: Architecture — system design, data flow, stack decisions for BankMicro
