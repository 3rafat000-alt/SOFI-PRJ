# HANDOFFS (ticket queue) — SAAS-092
...
task: produce Journey Map for SAAS-092 (EduFinance)
consumes: docs/PRD.md, _context/CONTEXT.md
expected: projects/saas-100-ideas/08-finance/SAAS-092/docs/JOURNEY_MAP.md
...
from: chief-product-strategist
to:   ui-ux-designer
task: produce Design Spec for SAAS-092 (EduFinance)
...
task: produce Architecture Spec for SAAS-092 (EduFinance)
