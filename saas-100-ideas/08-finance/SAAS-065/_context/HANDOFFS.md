# HANDOFFS (ticket queue) — SAAS-065
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for GoldPrice.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for GoldPrice.
