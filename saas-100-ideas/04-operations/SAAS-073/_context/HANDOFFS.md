# HANDOFFS (ticket queue) — SAAS-073
...
task: Discovery — user research, journey mapping, problem validation for WaterMgt
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for WaterMgt
...
task: Architecture — system design, data flow, stack decisions for WaterMgt
