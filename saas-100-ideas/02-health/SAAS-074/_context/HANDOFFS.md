# HANDOFFS (ticket queue) — SAAS-074
...
task: Discovery — user research, journey mapping, problem validation for NurseryPro
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for NurseryPro
...
task: Architecture — system design, data flow, stack decisions for NurseryPro
