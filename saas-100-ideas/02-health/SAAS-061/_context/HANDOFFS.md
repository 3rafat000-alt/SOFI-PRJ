# HANDOFFS (ticket queue) — SAAS-061
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for LabMgt.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for LabMgt.
