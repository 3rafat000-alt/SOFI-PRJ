# HANDOFFS (ticket queue) — SAAS-062
...
task: design customer journey map — lifecycle stages, touchpoints, emotion curve for DentistPro.
...
to:   ui-ux-designer
task: produce prototype spec, accessibility matrix, and design system for DentistPro.
