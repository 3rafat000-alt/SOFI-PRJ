# HANDOFFS (ticket queue) — SAAS-079
...
task: Discovery — user research, journey mapping, problem validation for PharmacyRx
...
to:   ui-ux-designer
task: Design — prototype spec, accessibility matrix, design system for PharmacyRx
...
task: Architecture — system design, data flow, stack decisions for PharmacyRx
